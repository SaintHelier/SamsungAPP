...
public class MyMonthAdapter extends ArrayAdapter<MyMonth> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.layout, null);
        }
